"""Docs: https://franckalbinet.github.io/marisco/handlers/pipeline/contracts.html.md"""
...
class _RawHandlerContract(BaseModel):
    ...
    measurement_defaults: dict[str, Any] = Field(default_factory=dict)
...
class HandlerConfig(BaseModel):
    ...
    def available_columns(self) -> frozenset[str]:
        return self.mapped_columns | self.melt_columns | self.datetime_columns | frozenset(self.measurement_defaults)
