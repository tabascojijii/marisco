...
Docs: https://franckalbinet.github.io/marisco/api/decoders.html.md"""
...
# %% ../nbs/api/decoders.ipynb #04f9c88f
...
# %% ../nbs/api/decoders.ipynb #e541d0e2
class NetCDFDecoder:
...
# %% ../nbs/api/decoders.ipynb #a7cdcebd
@patch
...
# %% ../nbs/api/decoders.ipynb #1c49a07c
@patch
...
# %% ../nbs/api/decoders.ipynb #b7c883f9
@patch
...
# %% ../nbs/api/decoders.ipynb #b1774dfd
@patch
