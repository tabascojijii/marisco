"""Infra base classes + standard 11-rail CBs + legacy CBs.
...
# %% auto #0
__all__ = ['Callback', 'PerGroupCB', 'run_cbs', 'Transformer', 'SanitizeLonLatCB', 'RemapCB', 'SoftRemapCB',
...
# %% ../../nbs/api/callbacks/core.ipynb #949d6471
...
# %% ../../nbs/api/callbacks/core.ipynb #9da3e703
...
# %% ../../nbs/api/callbacks/core.ipynb #1ea2cc64
...
# %% ../../nbs/api/callbacks/core.ipynb #d7982397
...
# %% ../../nbs/api/callbacks/core.ipynb #8cf07327
...
# %% ../../nbs/api/callbacks/core.ipynb #3653a68d
...
# %% ../../nbs/api/callbacks/core.ipynb #c787de45
