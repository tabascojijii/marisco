...
Docs: https://franckalbinet.github.io/marisco/api/data/_core.html.md"""

# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/api/data/_core.ipynb.

# %% ../../nbs/api/data/_core.ipynb #7552f83f
...
# %% ../../nbs/api/data/_core.ipynb #cf9bdc43
class DumpExploder():
