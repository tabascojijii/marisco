...
| REQ-GRAN-HOOK | `docs/requirements.md` § Granularity Allocation | PLAN-004 | RM-006 | `docs/requirements.md`, `docs/plan.md`, `docs/roadmap.md` | `.git/hooks/post-commit` |
...
| REQ-LOW-FRICTION-VALIDATION | `docs/requirements.md` § Non-Functional Requirements | PLAN-004 | RM-006, RM-008 | `AGENTS.md`, `docs/requirements.md`, `docs/plan.md`, `docs/roadmap.md` | `.git/hooks/post-commit`, hook run log |
